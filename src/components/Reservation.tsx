...
export default function Reservation() {
  const hasOnlineUrl = !!storeData.reservation.onlineUrl
  ...
  return (
    <section id="reservation" className="py-20 bg-white">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className={`grid ${hasOnlineUrl ? 'sm:grid-cols-2' : 'sm:grid-cols-1 max-w-sm mx-auto'} gap-6 mb-8`}>
